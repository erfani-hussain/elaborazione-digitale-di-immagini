function margini_verticali (vecchi_pixels, nuovi_pixels, larghezza_immagine, altezza_immagine) {
    for (let riga = 0; riga < altezza_immagine; riga++) {
        for (let colonna = 0; colonna < larghezza_immagine; colonna++) {
            ...
            const rosso = pixel_alto_sinistra[0] + pixel_centro_sinistra[0]*2 + pixel_basso_sinistra[0] - pixel_alto_destra[0] - pixel_centro_destra[0]*2 - pixel_basso_destra[0]
